...
import org.liuxixi.demo.patterns.creation.factory.FactoryMethod.*;
...
public class FactoryClient {
    ...
    public static void testSampleFactory() {
        ...
        AbstractProduct product1 = new SampleFactory().createProduct(new AbstractProduct.CarProduct());
        product1.productInformation();

        AbstractProduct product2 = new SampleFactory().createProduct(new AbstractProduct.TrainProduct());
        product2.productInformation();

        AbstractProduct product3 = new SampleFactory().createProduct(new AbstractProduct.AirplaneProduct());
        product3.productInformation();
        ...
        AbstractProduct product5 = new SampleFactory().createProduct(AbstractProduct.CarProduct.class.getSimpleName());
        product5.productInformation();

        AbstractProduct product6 = new SampleFactory().createProduct(AbstractProduct.TrainProduct.class.getSimpleName());
        product6.productInformation();

        AbstractProduct product7 = new SampleFactory().createProduct(AbstractProduct.AirplaneProduct.class.getSimpleName());
